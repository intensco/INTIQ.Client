...
public class RsaCsrBuilder
{
    public CertificateSigningRequestRsa BuildCertificateSigningRequest(
        string? csrTitle,
        ...
        RsaCryptographyKeys keyPairs)
    {
        ...
        var csrData = new CertificateSigningRequestRsaData
        {
        ...
        return new CertificateSigningRequestRsa
        {
            Data = csrData,
            Version = 1,
        };
